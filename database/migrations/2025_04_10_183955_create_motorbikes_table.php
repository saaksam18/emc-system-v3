...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('motorbikes', function (Blueprint $table) {
            ...
            $table->year('year'); // Manufacturing year of the motorbike. Required.
            ...
            $table->string('color'); // Color of the motorbike (e.g., Red, Black, White). Optional.
            ...
            $table->decimal('weekly_rental_price', 8, 2)->unsigned(); // Cost to rent the motorbike per week (e.g., 15.00). Required, unsigned decimal.
            $table->decimal('monthly_rental_price', 8, 2)->unsigned(); // Cost to rent the motorbike per week (e.g., 15.00). Required, unsigned decimal.
            ...
            $table->text('notes')->nullable(); // Any additional notes or remarks about the motorbike (e.g., condition details, specific features). Optional.
