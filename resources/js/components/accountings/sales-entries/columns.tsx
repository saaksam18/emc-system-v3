...
export const columns: ColumnDef<SaleTransaction>[] = [
    {
        accessorKey: 'sale_no',
        header: ({ column }) => (
    ...
    },
    {
        ...
        cell: ({ row }) => {
            try {
                const createdAt = new Date(row.original.sale_date);
            ...
            return (
                <>
                    ...
                    {paymentType === 'On Credit' && (
                        <span className="inline-flex rounded-full bg-yellow-100 px-2 text-xs leading-5 font-semibold text-yellow-800">On Credit</span>
                    )}
                </>
            );
        },
