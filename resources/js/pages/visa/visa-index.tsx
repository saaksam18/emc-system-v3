...
import { TableMeta } from '@/components/customers/columns'; // Adjust path
import { Create } from '@/components/visas/sheets/create'; // Adjust path

// --- Type Imports ---
// Make sure these types are correctly defined in '@/types'
import type { BreadcrumbItem, Customers, User } from '@/types'; // Added 'type' keyword
...
const CustomersIndex: React.FC<PageProps> = ({ customers, users }) => {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <div className="grid auto-rows-min gap-4 md:grid-cols-3">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>FPCS Document</CardTitle>
                        </CardHeader>
                    </Card>
                </div>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Visa Customers Management</CardTitle>
                        <CardDescription>View, create, edit, and manage visa extension customer records.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        ...
                        <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div className="flex gap-2">
                                <Button variant="default" onClick={handleCreateClick} className="w-full shrink-0 sm:w-auto">
                                    ...
                                    <User2 className="mr-2 h-4 w-4" /> Add Visa Customer
                                </Button>
                ...
                <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                    <SheetContent className="overflow-y-auto sm:max-w-lg">
                        ...
                        {sheetMode === 'create' && (
                            <>
                                <SheetHeader>
                                    <SheetTitle>Create New Visa Customer</SheetTitle>
                                    <SheetDescription>Enter the details for the new visa customer.</SheetDescription>
                                </SheetHeader>
                                <Create
                                    // Pass latest contactTypes from usePage if available
                                    customers={pageProps.customers || customers || []}
                                    users={pageProps.users || users || []}
