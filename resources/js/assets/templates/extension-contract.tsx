    ...
    return (
        <div className="min-h-screen bg-gray-100 p-4 font-sans">
            <div className="mx-auto max-w-4xl space-y-8 rounded-xl bg-white p-8 shadow-lg">
                ...
                {/* Extension/Exchange Form */}
                <div className="space-y-4 rounded-lg border border-black p-4">
                    <h3 className="text-center font-bold">Motorbike Rental Extension/Exchange</h3>
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <label className="block">
                            Today's Date:
                            <input
                        ...
                        <label className="block">
                            Next Return Date and Time:
                            <input
                                type="date"
                                name="nextReturnDate"
                                value={formData.nextReturnDate}
                                onChange={handleInputChange}
                                className="block w-full border-b border-black bg-transparent outline-none"
                            />
                        </label>
                    ...
                    <div className="mt-4 flex items-center space-x-4">
                        ...
                        <label>
                            <input
                                ...
                                name="contractType"
                                value="Extension"
                                checked={formData.contractType === 'Extension'}
                                onChange={handleInputChange}
                                className="mr-1"
                            />
                            Extension
                        ...
                        <label>
                            <input
                                ...
                                name="contractType"
                                value="Exchange"
                                checked={formData.contractType === 'Exchange'}
                                onChange={handleInputChange}
                                className="mr-1"
                            />
                            Exchange
                        ...
                        <label>
                            <input
                                ...
                                checked={formData.contractType === 'Exchange Deposit'}
                                onChange={handleInputChange}
                                className="mr-1"
                            />
                            Exchange Deposit
                    ...
                    <div className="mt-4">
                        <h4 className="font-bold">Present Rental Motorcycle</h4>
                        <div className="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-3">
                            ...
                            <label className="block">
                                ...
                                <input
                                    type="text"
                                    name="presentMotorType"
                                    value={formData.presentMotorType}
                                    onChange={handleInputChange}
                                    className="block w-full border-b border-black bg-transparent outline-none"
                                />
                            </label>
                    ...
                    <div className="mt-4">
                        <h4 className="font-bold">Previous Rental Motorcycle</h4>
                        <div className="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <label className="block">
                                Motor No:
                                <input
                                    type="text"
                                    name="previousMotorNo"
                                    value={formData.previousMotorNo}
                                    onChange={handleInputChange}
                                    className="block w-full border-b border-black bg-transparent outline-none"
                                />
                            </label>
                            <label className="block">
                                ...
                                <input
                                    type="text"
                                    name="previousMotorBrand"
                                    value={formData.previousMotorBrand}
                                    onChange={handleInputChange}
                                    className="block w-full border-b border-black bg-transparent outline-none"
                                />
                            </label>
                    ...
                    <div className="mt-4">
                        <h4 className="font-bold">Rental Period and Payment</h4>
                        <div className="mt-2 grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <label className="block">
                                Rental Period:
                                <input
                                    type="text"
                                    name="rentalPeriodExtension"
                                    value={formData.rentalPeriodExtension}
                                    onChange={handleInputChange}
                                    className="block w-full border-b border-black bg-transparent outline-none"
                                />
                            </label>
                            <label className="block">
                                ...
                                <input
                                    type="text"
                                    name="rentalFeeExtension"
                                    value={formData.rentalFeeExtension}
                                    onChange={handleInputChange}
                                    className="block w-full border-b border-black bg-transparent outline-none"
                                />
                            </label>
                    ...
                    <div className="mt-4">
                        <h4 className="font-bold">Deposit Exchange</h4>
                                ...
                                <div className="mt-2 flex items-center space-x-2">
                                    <label>
                                        <input
                                            ...
                                            value="Passport"
                                            checked={formData.previousDeposit === 'Passport'}
                                            onChange={handleInputChange}
                                            className="mr-1"
                                        />
                                        Passport
                                    ...
                                    <label>
                                        <input
                                            ...
                                            name="previousDeposit"
                                            value="Deposit Fee"
                                            checked={formData.previousDeposit === 'Deposit Fee'}
                                            onChange={handleInputChange}
                                            className="mr-1"
                                        />
                                        Deposit Fee
                                    ...
                                    <label>
                                        <input
                                            ...
                                            name="previousDeposit"
                                            value="Other"
                                            checked={formData.previousDeposit === 'Other'}
                                            onChange={handleInputChange}
                                            className="mr-1"
                                        />
                                        Other
                                    </label>
                                    {formData.previousDeposit === 'Other' && (
                                        <input
                                            type="text"
                                            name="otherPreviousDeposit"
                                            value={formData.otherPreviousDeposit}
                                            onChange={handleInputChange}
                                            placeholder="Specify"
                                ...
                                <div className="mt-2 flex items-center space-x-2">
                                    <label>
                                        <input
                                            ...
                                            name="newDeposit"
                                            value="Passport"
                                            checked={formData.newDeposit === 'Passport'}
                                            onChange={handleInputChange}
                                            className="mr-1"
                                        />
                                        Passport
                                    ...
                                    <label>
                                        <input
                                            ...
                                            name="newDeposit"
                                            value="Deposit Fee"
                                            checked={formData.newDeposit === 'Deposit Fee'}
                                            onChange={handleInputChange}
                                            className="mr-1"
                                        />
                                        Deposit Fee
                                    ...
                                    <label>
                                        <input
                                            ...
                                            name="newDeposit"
                                            value="Other"
                                            checked={formData.newDeposit === 'Other'}
                                            onChange={handleInputChange}
                                            className="mr-1"
                                        />
                                        Other
                                    </label>
                                    {formData.newDeposit === 'Other' && (
                                        <input
                                            type="text"
                                            name="otherNewDeposit"
                                            value={formData.otherNewDeposit}
                                            onChange={handleInputChange}
                                            placeholder="Specify"
                                            className="border-b border-black bg-transparent outline-none"
                                        />
